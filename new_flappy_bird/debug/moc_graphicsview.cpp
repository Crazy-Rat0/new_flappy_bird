...
QT_MOC_LITERAL(6, 57, 15), // "updateBestScore"
QT_MOC_LITERAL(7, 73, 8) // "gameOver"

    },
    "graphicsView\0clicked\0\0redrawBird\0"
    "redrawPipes\0updateScore\0updateBestScore\0"
    "gameOver"
};
...
void graphicsView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->updateBestScore(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&graphicsView::clicked)) {
                *result = 0;
                return;
            }
        }
