...
QT_MOC_LITERAL(1, 5, 13), // "isDeadChanged"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 8), // "xChanged"
QT_MOC_LITERAL(4, 29, 8), // "yChanged"
QT_MOC_LITERAL(5, 38, 4), // "drop"
QT_MOC_LITERAL(6, 43, 3), // "fly"
QT_MOC_LITERAL(7, 47, 11) // "changeImage"

    },
    "bird\0isDeadChanged\0\0xChanged\0yChanged\0"
    "drop\0fly\0changeImage"
};
...
void bird::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (bird::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&bird::isDeadChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (bird::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&bird::xChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (bird::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&bird::yChanged)) {
                *result = 2;
                return;
            }
        }
