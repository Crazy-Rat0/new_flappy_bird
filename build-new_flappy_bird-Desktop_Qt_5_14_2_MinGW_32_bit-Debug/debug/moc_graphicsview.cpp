...
#include <memory>
#include "../../new_flappy_bird/view/graphicsview.h"
...
QT_MOC_LITERAL(1, 13, 11), // "redraw_bird"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 1) // "y"

    },
    "graphicsView\0redraw_bird\0\0y"
};
...
void graphicsView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->redraw_bird((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
