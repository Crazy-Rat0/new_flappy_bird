...
#include <memory>
#include "../../new_flappy_bird/common/map.h"
...
QT_MOC_LITERAL(1, 4, 12), // "pipesUpdated"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 17) // "collisionDetected"

    },
    "map\0pipesUpdated\0\0collisionDetected"
};
...
void map::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->pipesUpdated(); break;
        case 1: _t->collisionDetected(); break;
        default: ;
        }
        ...
        {
            using _t = void (map::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&map::pipesUpdated)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (map::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&map::collisionDetected)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void map::pipesUpdated()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void map::collisionDetected()
{
